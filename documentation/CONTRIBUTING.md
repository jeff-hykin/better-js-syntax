...
- Create a `your_feature.js` file in the `language_examples/` folder. Once it is created, add code to it that demonstrates your feature (more demonstration the better).
...
```json
{
    ...
    "name": "punctuation.separator.attribute.js",
    "patterns": [
        {
...
```json
{
    ...
    "beginCaptures": {
        "0": {
            "name": "punctuation.section.attribute.begin.js"
        }
    },
    "endCaptures": {
        "0": {
            "name": "punctuation.section.attribute.end.js"
        }
    },
    "name": "support.other.attribute.js",
    "patterns": [
        {
